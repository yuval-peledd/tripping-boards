...
custom_event = pygame.event.Event(CUSTOM_EVENT)
...
async def main():
    # Rest of your script can continue running here
    ...
    while True:
        ...
        await chess.multiplayer(win, None, None, prefs)
    ...
    #                 run = False
    #             elif ret != 1:
    #                 run = await chess.multiplayer(win, ret[0], ret[1], prefs)
    #
